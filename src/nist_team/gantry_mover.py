...
from nist_team.srv import MoveGantry, MoveGantryResponse
...
class GantryMover:
    def __init__(self):
        ...
        self.move_group = moveit_commander.MoveGroupCommander(
            manipulator_name, robot_description=robot_description, ns=ns)

        # Advertise service
        self.move_gantry_srv = rospy.Service(
            'move_gantry', MoveGantry, self.move_gantry)
